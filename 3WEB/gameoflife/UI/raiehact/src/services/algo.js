...
export const generateInitialGridFalse = (size) => Array.from({ length: size }, () => Array.from({ length: size }, () => false));
...
export const isOutOfBound = ({ length }, { x, y }) => x < 0 || y < 0 || x >= length || y >= length;
